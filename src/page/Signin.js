      ...
      <div className="body2">
        <section className="alpha  mx-auto box-shadow">
          <div className="p-5 ">
            ...
            <div className={`admin_login ${isClicked["c#1"] ? "transition active" : ""}`}>
              <div className="row">
                <div className="col-12">
                  ...
                  <div className="row">
                    ...
                    <Link to="/dash" className="des">Login</Link>
                    </button>
                  </div>
                </div>
              </div>
            </div>
            <div className={`user_login ${isClicked["c#2"] ? "transition active" : ""}`}>
              <div className="row">
                <div className="col-12">
                  <div className="row">
                    <label>Username:</label>
